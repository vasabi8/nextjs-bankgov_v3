          ...
          <Grid item xs={12} md={4}>
            ...
            <CmtList
              ...
              renderRow={(item, index) => (
                <CountryListItem key={index} country={item} onClick={() => setCountry(item)}
                                 flagCode={country.flagCode} />
              )}
            />
          </Grid>
          <Grid item xs={12} md={8}>
            <VisitorChart data={country.data} color={country.badgeColor}
                          chartGradientColor={country.chartGradientColor} />
          </Grid>
        </GridContainer>
      </CmtCardContent>
    </CmtCard>
